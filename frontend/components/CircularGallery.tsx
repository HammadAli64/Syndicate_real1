...
function autoBind(instance: object): void {
  ...
  Object.getOwnPropertyNames(proto).forEach((key) => {
    if (key !== 'constructor' && typeof (instance as Record<string, unknown>)[key] === 'function') {
      ;(instance as Record<string, unknown>)[key] = (instance as Record<string, unknown>)[key] as unknown as never
...
function createTextTexture(gl: GL, text: string, font = 'bold 30px monospace', color = 'black'): { texture: Texture; width: number; height: number } {
...
export default function CircularGallery({
  ...
  return <div ref={containerRef} className="h-full w-full cursor-grab overflow-hidden active:cursor-grabbing" />
}
